...
mkdir -p ~/Library/Application\ Support/telegramss/temp
mkdir -p ~/Library/Application\ Support/telegramss/cache
mkdir -p ~/Library/Application\ Support/telegramss/screenshots
mkdir -p ~/Library/Application\ Support/telegramss/extra_screenshots
